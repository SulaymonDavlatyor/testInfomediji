 ...
 */
final class Version20231220170200 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE subscription (id INT NOT NULL, subscriber_id INT NOT NULL, subscribed_to_id INT NOT NULL, PRIMARY KEY(id))');
